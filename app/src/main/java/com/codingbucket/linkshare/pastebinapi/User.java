...
public class User {
    ...
    public User(PastebinAPI api, String username, String password) throws PastebinException {
        this.api = api;
        ...
        try { login.withURL(new URL("https://pastebin.com/api/api_login.php")); }
...
this.api=api;
    ...
    public Paste[] getPastes(int results_limit) throws PastebinException {
        return api.parse(api.getNewPoster().withArg("api_results_limit", results_limit).withArg("api_option", "list").withArg("api_user_key",userkey).post());
    }
    ...
    public String getRawPaste(String key){
        Poster p = api.getNewPoster();
        p.withArg("api_option", "show_paste");
        p.withArg("api_paste_key", key);
        p.withArg("api_user_key", "15b4351df7b49dfe5afbe19156ff6a83");
        try {
            p.withURL(new URL("https://pastebin.com/api/api_raw.php"));
